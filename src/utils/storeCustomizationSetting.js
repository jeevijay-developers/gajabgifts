export const storeCustomization = {
  ...
  home: {
    ...
    quick_delivery_description: {
      en: "There are many products you will find in our shop, Choose your daily necessary product from our GajabGifts shop and get some special offers. See Our latest discounted products from here and get a special discount.",
      de: "Es gibt viele Produkte, die Sie in unserem Shop finden. Wählen Sie Ihr täglich benötigtes Produkt aus unserem GajabGifts-Shop und erhalten Sie einige Sonderangebote. Sehen Sie sich hier unsere neuesten reduzierten Produkte an und sichern Sie sich einen Sonderrabatt.",
    },
    ...
    daily_need_description: {
      en: "There are many products you will find in our shop, Choose your daily necessary product from our GajabGifts shop and get some special offers.",
      de: "Es gibt viele Produkte, die Sie in unserem Shop finden. Wählen Sie Ihr täglich benötigtes Produkt aus unserem GajabGifts-Shop und erhalten Sie einige Sonderangebote.",
    },
  ...
  about_us: {
    ...
    top_title: {
      en: "Welcome to our GajabGifts shop",
      de: "Willkommen in unserem GajabGifts-Shop",
    },
    top_description: {
  ...
  contact_us: {
    ...
    email_box_email: {
      en: "info@GajabGifts.com ",
      de: "info@GajabGifts.com",
    },
    email_box_text: {
  ...
  faq: {
    ...
    faq_one: {
      en: "How does the GajabGifts work?",
      de: "Wie funktioniert der GajabGifts?",
    },
    description_one: {
    ...
    faq_five: {
      en: "What is GajabGifts EC2 auto scaling?",
      de: "Was ist die automatische Skalierung von GajabGifts EC2?",
    },
    description_five: {
      en: "Continually impact seamless imperatives for best-of-breed best practices. Phosfluorescently facilitate parallel applications with unique imperatives. Proactively plagiarize functionalized deliverables via inexpensive solutions. Collaboratively embrace web-enabled infomediaries rather than diverse testing procedures.",
    ...
    faq_six: {
      en: "What are the benefits of using GajabGifts affliate?",
  ...
  footer: {
    ...
    social_facebook: "https://www.facebook.com/share/159mbaNXRC/",
    social_instagram: "https://www.instagram.com/thegazabgifts/",
